...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="addUser.action" >  
      <div class="form-group">
        <div class="label">
          <label>用户名：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50"  name="user.uname"  id="username"  onblur="return checkuname()" />
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="password" class="input w50" name="user.pwd"   id="txtConfirmPwd" onblur="return checkpwdc()"/>
        ...
        <div class="form-group">
          ...
          <div class="field">
           <input name="user.tel" type="text" class="input w50" id="txtPhone" onblur="return checktel()"/>
        ...
        <div class="form-group">
          ...
          <div class="field">
           <input  type="text" name="user.address" class="input w50"  />
