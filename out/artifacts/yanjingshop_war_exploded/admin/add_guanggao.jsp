...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="addguanggao.action"  enctype="multipart/form-data"> <!--  enctype="multipart/form-data" -->
      <div class="form-group">
        ...
        <div class="field">
          ...
          <input type="hidden" name="gg.type"  value="新闻"/>
        </div>
        </div>
         <div class="form-group">
         <div class="label">
        ...
        <div class="field">
         <textarea id="editor_id" id="note" name="gg.note" style="width:800px;height:400px;" ></textarea>
        </div>
        </div>
          <div class="form-group">
       <div class="label">
