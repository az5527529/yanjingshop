...
<form method="post" action="addBbsFore.action">
  <div id="reg-top">&nbsp;&nbsp;&nbsp;&nbsp;评价</div>
 <div id="reg-mleft">
  
    <ul>
      <li class="m">菜品名称：</li>
      <li class="r" >
        <input name="bbs.name" type="text" class="box txtInit" id="txtNo" value="<s:property value="goods.name" />" />
        <input name="bbs.gid" type="hidden" value="<s:property value="goods.id" />" />
