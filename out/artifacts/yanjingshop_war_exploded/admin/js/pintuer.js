$(function(){
	...
	$('.banner').each(function(){
		...
		var yanjingshops=e.attr("data-yanjingshop");
		var yanjingshops_s=e.attr("data-small");
		var yanjingshops_m=e.attr("data-middle");
		var yanjingshops_b=e.attr("data-big");
		var num=e.find(".carousel .yanjingshop").length;
		var win=$(window).width();
		var i=1;

		if(interval==null){interval=5};
		if(yanjingshops==null || yanjingshops<1){yanjingshops=1};
		if(yanjingshops_s!=null && win>760){yanjingshops=yanjingshops_s};
		if(yanjingshops_m!=null && win>1000){yanjingshops=yanjingshops_m};
		if(yanjingshops_b!=null && win>1200){yanjingshops=yanjingshops_b};

		var yanjingshopWidth=Math.ceil(e.outerWidth()/yanjingshops);
		var page=Math.ceil(num/yanjingshops);
		e.find(".carousel .yanjingshop").css("width",yanjingshopWidth+ "px");
		e.find(".carousel").css("width",yanjingshopWidth*num + "px");
		
		var carousel=function(){
			i++;
			if(i>page){i=1;}
			$showbanner(e,i,yanjingshops,num);
		};
		...
		if(pointer!=0 && page>1){
			...
			pager.find("li").click(function(){
				$showbanner(e,$(this).val(),yanjingshops,num);
			});
	...
	$showbanner=function(e,i,yanjingshops,num){
		var after=0,leftx=0;
		leftx = - Math.ceil(e.outerWidth()/yanjingshops)*(yanjingshops)*(i-1);
		if(i*yanjingshops > num){after=i*yanjingshops-num;leftx= - Math.ceil(e.outerWidth()/yanjingshops)*(num-yanjingshops);};
