...
<div id="reg">
  ...
  <div id="reg-mleft">
  <form method="post" action="updateUserInfo.action" >
    <ul>
      <li class="m">用户名： </li>
      <li class="r" >
        <input name="user.uname" type="text" class="box txtInit" id="username" onblur="return checkuname()" value="<s:property value="user.uname"/>" readonly="readonly"/>
        <input name="user.uid" type="hidden" id="uid"  value="<s:property value="user.uid"/>" />
         <input type="hidden"  value="<s:property value="user.addr"/>" name="user.addr" />
          <input type="hidden"  value="<s:property value="user.money"/>" name="user.money" />
           <input type="hidden"  value= "<s:property value="user.ustate"/>" name="user.ustate" />
           <input type="hidden"  value= "<s:property value="user.level"/>" name="user.level" />
           <input type="hidden"  value= "<s:property value="user.pubtime"/>" name="user.pubtime" />
        <span id='checku' class="spanInit" ></span></li>
      <li class="m">真实姓名： </li>
      <li class="r" >
        <input name="user.tname" type="text" class="box txtInit"  value="<s:property value="user.tname"/>"/>
        <span id='checku2' class="spanInit" ></span></li>
      <li class="m">密码 </li>
      <li class="r">
        <input name="user.pwd" type="password" class="box txtInit" value="<s:property value="user.pwd"/>"/>
        <span id='prompt_pwd'  class="spanInit" ></span></li>
      <li class="m">手机号码： </li>
      <li class="r">
        <input name="user.tel" type="text" class="box txtInit" id="txtPhone" onblur="return checktel()" value="<s:property value="user.tel"/>"/>
        <span id='prompt_phone' class="spanInit" ></span></li>
        <li class="m">年龄： </li>
      <li class="r">
        <input name="user.birth" type="text" class="box txtInit" id="txtPhone3" onblur="return checktel4()" value="<s:property value="user.birth"/>"/>
        <span id='prompt_phone3' class="spanInit" ></span></li>
      <li class="m">QQ： </li>
      <li class="r">
        <input name="user.qq" type="text" class="box txtInit" id="txtPhone3" onblur="return checktel4()" value="<s:property value="user.qq"/>"/>
        <span id='prompt_phone3' class="spanInit" ></span></li>
      <li class="m">收货地址 :</li>
      <li class="r"><input name="user.address" type="text" class="box txtInit" id=""  value="<s:property value="user.address"/>"/>
        <span id='' class="spanInit"  ></span> </li>
    <li class="m">预留问题 </li>
      <li class="r"><input name="user.mbanswer" type="text" class="box txtInit" id="txtName1" onblur="return checkname1()" value="<s:property value="user.mbanswer"/>"/>
        <span id='prompt_name1' class="spanInit"  ></span> </li>
    <li class="m">问题答案 </li>
      <li class="r"><input name="user.question" type="text" class="box txtInit" id="txtName2" onblur="return checkname2()" value="<s:property value="user.question"/>"/>
