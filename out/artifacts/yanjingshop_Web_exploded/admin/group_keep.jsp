...
<div><a href="show.action?id=<s:property value="goods.id"/>"><img src="./upload/<s:property value="goods.img"/>" width="305" height="200" /></a></div>
<div class="tuangouy-m"><a href="show.action?id=<s:property value="goods.id"/>"><s:property value="goods.name"/></a><br />
<%-- <s:property value="goods.miaoshu"/> --%><a href="deleteKeep.action?id=<s:property value="kid"/>">删除</a><br />
<span><s:property value="goods.price"/>元</span>
</div>
