    ...
    <table class="table table-hover text-center">
      <tr>
       ...
       <s:iterator value="page.pageList" >
        <tr>
          ...
          <s:if test="#session.cuser.uname=='admin'" ><td ><s:property value="pwd" /></td></s:if>
          ...
          <a class="button border-main" href="doUpdateUser.action?id=<s:property value="uid" />" ><span class="icon-trash-o"></span>修改</a> 
          <s:if test="uname=='admin'">
          超管不可删除
          </s:if> 
          <s:if test="uname!='admin'">
          <a class="button border-red" href="deleteuser.action?id=<s:property value="uid" />" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> 
          </s:if> 
          </div></td>
      ...
      <tr>
       ...
       <td colspan="2">当前显示第
			...
			页
			<div align="center">
				<a href="querylist.action?page.pageIndex=1"> 首页</a>
				<s:property value="totalpages" />
				<a <s:if test="page.pageIndex<=1"> href="javascript:false;"</s:if>
					<s:else>href="querylist.action?page.pageIndex=<s:property value='page.pageIndex-1' />"</s:else>>上一页</a>
				<a
					<s:if test="page.pageIndex>=page.totalpages" > href="javascript:false;"</s:if>
					<s:else>href="querylist.action?page.pageIndex=<s:property value='page.pageIndex+1' />"</s:else>>下一页</a>
				<a
					href="querylist.action?page.pageIndex=<s:property value="page.totalpages" />">末页</a>
