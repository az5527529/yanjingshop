...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 内容列表</strong> <a href="" style="float:right; display:none;">字段</a></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <!-- <a class="button border-main icon-plus-square-o" href="add_ftype.jsp">收件箱</a> --> </li>
        <li>
          </li>
    ...
    <table class="table table-hover text-center">
      ...
      <s:iterator value="page.pageList" >
        <tr>
          ...
          <td style="width:400px;overflow:hidden;"><s:property value="note" /></td>
          <td><div class="button-group"> <a class="button border-main" href="doUpdateBbs.action?id=<s:property value="id" />"><span class="icon-edit"></span>查看回复</a> 
