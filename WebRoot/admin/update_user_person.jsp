    ...
    <form method="post" class="form-x" action="updatePersionUser.action" >  
      <div class="form-group">
        ...
        <div class="field">
          ...
          <input type="hidden"  value="<s:property value="user.qita1"/>"name="user.qita1" />
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" id="url1" name="user.address" class="input w50" value="<s:property value="user.address"/>" />
        </div>
      </div>     
      <div class="form-group">
        <div class="label">
